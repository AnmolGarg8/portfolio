...
const techItems = [
  ...
  { name: 'Deep Learning', size: 85 },
  { name: 'NLP', size: 80 },
  { name: 'Computer Vision', size: 80 },
  { name: 'ESP32', size: 85 },
  { name: 'IoT', size: 82 },
  { name: 'TensorFlow', size: 75 },
  { name: 'PyTorch', size: 75 },
  { name: 'FastAPI', size: 78 },
  { name: 'React.js', size: 78 },
  { name: 'LangChain', size: 72 },
  { name: 'RAG', size: 70 },
  { name: 'Docker', size: 65 },
  { name: 'AWS', size: 68 },
  { name: 'Git & GitHub', size: 62 },
  { name: 'Embedded C++', size: 72 },
  { name: 'LeetCode', size: 62 },
  { name: 'Scikit-learn', size: 70 },
  { name: 'OpenCV', size: 72 },
]
